...
Revision ID: 5c9d266d55bb
Revises: 0c1330a25319
Create Date: 2025-01-21 11:36:12.157789
...
revision = "5c9d266d55bb"
down_revision = "0c1330a25319"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Add other columns or changes as needed
...
def downgrade():
    ...
    # Remove other columns or changes as needed
    # ### end Alembic commands ###
