"""Retrying Changing the Database

Revision ID: 3a5814adf2d6
Revises: 5c9d266d55bb
Create Date: 2025-01-21 11:39:19.883571
...
revision = "3a5814adf2d6"
down_revision = "5c9d266d55bb"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column(
        "users", sa.Column("grade_level", sa.String(length=20), nullable=True)
    )
    op.drop_column("users", "profile_picture")
    op.add_column(
        "users", sa.Column("profile_photo", sa.String(length=255), nullable=True)
    )
