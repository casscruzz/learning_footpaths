"""update TempQuizResult and remove footpath_name in userexhibitionprogress

Revision ID: 868e9e4405eb
Revises: 9d49020c199e
Create Date: 2024-12-08 20:58:35.194666
...
revision = "868e9e4405eb"
down_revision = "9d49020c199e"
branch_labels = None
depends_on = None
...
def upgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "temp_quiz_results", sa.Column("footpath_id", sa.Integer(), nullable=True)
    )
...
def downgrade():
    ...
    op.add_column(
        ...
        sa.Column("footpath_name", sa.String(), nullable=True),
    )
    op.drop_column("temp_quiz_results", "footpath_id")
    # ### end Alembic commands ###
