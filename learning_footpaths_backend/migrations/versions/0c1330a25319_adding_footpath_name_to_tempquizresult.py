"""Adding Footpath Name to TempQuizResult

Revision ID: 0c1330a25319
Revises: 868e9e4405eb
Create Date: 2024-12-09 14:46:46.800540
...
revision = "0c1330a25319"
down_revision = "868e9e4405eb"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column(
        "temp_quiz_results", sa.Column("footpath_name", sa.String(), nullable=True)
    )
...
def upgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "temp_quiz_results", sa.Column("footpath_name", sa.Integer(), nullable=True)
    )
    # op.drop_column('user_exhibition_progress', 'footpath_name')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    # op.add_column('user_exhibition_progress', sa.Column('footpath_name', sa.String(), nullable=True))
    op.drop_column("temp_quiz_results", "footpath_name")
    # ### end Alembic commands ###
