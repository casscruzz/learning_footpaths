"""Adding footpath_id instead of footpath_name

Revision ID: 9d49020c199e
Revises: db5efcf0e3f8
Create Date: 2024-12-08 20:25:36.312968
...
revision = "9d49020c199e"
down_revision = "db5efcf0e3f8"
branch_labels = None
depends_on = None
...
def upgrade():
    op.add_column(
        ...
        sa.Column("footpath_id", sa.Integer(), nullable=True),
    )
    op.drop_column("user_exhibition_progress", "footpath_name")


def downgrade():
    op.drop_column("user_exhibition_progress", "footpath_id")
